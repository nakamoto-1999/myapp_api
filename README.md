...
<h3>工夫した点</h3>
<div>最も工夫した点は、ディベートに特化した以下3つの機能を実装したことです。</div>
<li>
  <ul>赤と青に別れて論戦を交わす機能</ul>
  <ul>ユーザー同士が赤と青に別れて論戦を交わす機能</ul>
  <ul>トピック主がディベートの妨げとなるユーザーを排除できる機能</ul>
</li>
<div>以上の3つの機能を実装することで、より建設的なディベートを行える場とように工夫しました。</div> 
