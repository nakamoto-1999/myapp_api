...
<h3>工夫した点</h3>
<div>
最も工夫した点は、ディベートに特化した3つの機能を実装したことです。</br>
1つ目はユーザー同士が赤と青に別れて論戦を交わす機能、2つ目はトピック主のユーザーがディベートに審判を下せる機能、3つ目はディベートの妨げとなるユーザーを、トピック主が排除できる機能です。</br>
以上の3つの機能を実装することで、より建設的なディベートを行える場とように工夫しました。</br>
</div> 
